...
export default function TopNavBar() {
  ...
  // ★ Display "All" location if role = Admin
  const displayLocation = () => {
    if (userDetails?.role?.toLowerCase() === "admin") return "All";
    return safe(userDetails?.officeLocation);
  };
  ...
  return (
    <div className="w-full">
      <div className="flex p-5 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="border bg-[#004AAD] rounded-xl text-white px-3 py-1.5">
            <h1 className="m-0">{displayLocation()}</h1>
          </div>
        ...
        >
          ...
          <div className="mt-4 flex gap-4 items-center">
            ...
            <div className="flex flex-col gap-1">
              ...
              {/* ★ Location display override for admin */}
